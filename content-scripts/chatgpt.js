...
const RESPONSE_MESSAGE_TYPE = "chatGPTResponse";
...
const PRE_SEND_IDLE_TIMEOUT_MS = 45000;
...
const RESPONSE_STABILITY_WINDOW_IDLE_MS = 550;
...
function isComposerInStopMode() {
  ...
  return buttons.some((button) => {
    ...
    return /\bstop\b/.test(combined) && isButtonUsable(button);
  });
}
